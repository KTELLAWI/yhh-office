...
export const packageTitleBGs = Object.freeze({
...
const Package = ({
  ...
  return (
    <div
      className={cn(
        "bg-[#171717]   rounded-[6px] px-3.5 pt-8 pb-6 h-full flex flex-col items-center",
        highlight && "bg-[#E12120]"
      )}
    >
      {children}
...
const PackagePrice = ({
  ...
  return (
    <span
      className={cn(
        "block text-white text-[32px] mb-1 font-semibold leading-[32px] text-center",
        className
      )}
    >
      {children}
...
const PackageFeatureList = ({
  ...
  return (
    <ul className={cn("text-white text-base m-0 p-0 w-full", className)}>
      {children}
    </ul>
  );
};
...
const PackageFeatureItem = ({
  ...
  return (
    <li
      className={cn(
        "text-white py-1 text-base border-t flex justify-between items-center border-[#2B2B2B]",
        className
      )}
    >
      <span className="featureItem text-[0.90rem] leading-[22px] pe-2">{title}</span>
...
const PackageCTA = ({
  ...
  return (
    <div className="grow mt-8 flex flex-col justify-end w-full">
      <ServicesButton
        className= {!exclusive? cn(highlight && "bg-white text-[#E12120] hover:bg-white",):cn("text-white bg-[#E12120] hover:bg-red-500")}
        calLink={calLink}
      >
        Book a meeting
      </ServicesButton>
