                    ...
                    <div
                        className="py-4 px-3 text-center lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center rounded-e-3xl lg:p-4 bg-[#171717]">
                       {
                        packageData?.popoular && (
                            <span className="flex items-center justify-between absolute top-6 right-0 px-2 py-1 bg-[#E12120] hover:bg-gray-300 rounded-s-3xl text-sm font-semibold text-white shadow-lg">
