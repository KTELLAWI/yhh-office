...
export function CardBlog({id, thumbnail, title, shortDescription, createdAt, withMargin}: Props) {
    //@ts-ignore
    const lang: "ar" | "en" = useLocale();
    
    return (
        <div className={withMargin ? "mt-0 md:mt-24" : ""}>
            <Link href={{ pathname: `/blog/[id]`, params: {id} }} locale={lang} className='flex flex-col justify-start decoration-[none]'>
                ...
                <div className='ml-[-0.9rem] px-4 md:ml-0 md:px-0 mt-5 md:mt-8'>
                    ...
                    <div className="flex justify-between gap-4 items-center">
                        ...
                        <div className='text-[.8rem] px-5 md:px-0 md:text-base text-[#69778c] '>{dayjs(createdAt).format('MMM DD, YYYY')}</div>
                    </div>
